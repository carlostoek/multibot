...
import tempfile
import os
from audio_converter import convert_audio_to_voice_note, get_file_size, is_supported_format
...
async def cmd_start(message: types.Message):
    await message.answer(
        "Welcome to the Audio to Voice Note Converter Bot!\n\n"
        "Send me an audio file (MP3, WAV, etc.) and I will convert it to a Telegram voice note."
    )
